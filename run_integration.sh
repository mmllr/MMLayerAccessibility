...
echo "[*] Perform tests"
${XCTOOL} -workspace Example/MMLayerAccessibilityDemo.xcworkspace \
-scheme MMLayerAccessibilityDemo \
...
${XCODEBUILD} -workspace Example/MMLayerAccessibilityDemo.xcworkspace \
-scheme MMLayerAccessibilityDemo \
